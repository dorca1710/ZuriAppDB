...
async function recoverPassword(req, res) {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `Tu nueva contraseña es: ${newPassword}. Recuerda cambiarla después de iniciar sesión.`,
    };
...
module.exports = {register, registerReemplazo, login, logout, refresh, user, mostrarReemplazos, eliminarReemplazo,recoverPassword}